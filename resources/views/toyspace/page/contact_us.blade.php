        ...
        <div class="card-body p-5">
          <div class="d-flex mb-3">
            <div class="col-md-6">
              ...
              <input class="form-control" type="text" placeholder="cth. Moch Surya" aria-label="default input example">
            </div>
            <div class="col-md-6">
              <label for="inputPassword5" class="form-label">Email</label>
              <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="cth.name@example.com">
            </div>
          </div>
  ...
  <section id="cta-chatNow" class="cta-chatNow">
    <div class="container">
      <div class="col-md-9">
        ...
        <p>Kirim pesan real-time dengan satu klik saja, mudah dan cepat, memastikan komunikasi yang efisien dan langsung dengan customer kami</p>
      </div>
      <div class="col-md-3">
        <a href="#" class="btn btn-primary-all">Kirim Pesan</a>
      </div>
